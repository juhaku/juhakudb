 ...
 *  public class DemoRepositoryImpl extends SimpleRepository&lt;Long, Book&gt; implements DemoRepository &#123;<br/>
 *  <br/>
 ...
 * @since 1.0.2
 */
public abstract class SimpleRepository<K, T> {
    ...
    public T findOne(Filter<T> filter) {
        ...
        return find(filter).get(0);  //TODO throw exception if not found
    }
